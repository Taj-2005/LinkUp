        ...
        <form
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2.5 xs:py-3 sm:py-3.5 text-sm rounded-lg xs:rounded-xl border ${theme.input} ${focusedField === "emailOrUsername" ? `${theme.inputFocus} ring-2` : ""
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onBlur={() => setFocusedField("")}
                placeholder="••••••••"
                className={`w-full px-3 py-2.5 xs:py-3 sm:py-3.5 text-sm rounded-lg xs:rounded-xl border ${theme.input} ${focusedField === "password" ? `${theme.inputFocus} ring-2` : ""
          ...
          <p className={`text-center text-xs ${theme.textSecondary} pt-2 xs:pt-3 sm:pt-4`}>
            ...
            <a href="/signup" className={`font-semibold ${theme.link} transition-colors cursor-pointer`}>
              Sign up
            </a>
          </p>
        </form>
