...
export default function Home() {
  ...
  return (
    <div className="w-full flex flex-row justify-between items-start bg-primary-light dark:bg-primary-dark min-h-screen">
      <div className="w-full m-2 md:m-2 min-h-[98vh] rounded-2xl flex flex-col md:flex-row overflow-hidden bg-left-nav-light dark:bg-left-nav-dark shadow-md border border-primary-light/30 dark:border-primary-dark/30">
        
        <div className="w-full md:w-[30%] border-b md:border-b-0 md:border-r border-primary-light/50 dark:border-primary-dark/50 bg-left-nav-light dark:bg-left-nav-dark p-4">
        ...
        <div className="w-full md:w-[70%] bg-right-nav-light dark:bg-right-nav-dark flex flex-col">
