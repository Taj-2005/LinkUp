  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className={`absolute top-20 left-10 w-72 h-72 ${darkMode ? "bg-violet-500/10" : "bg-violet-300/30"
            } rounded-full blur-3xl`}
        />
        <div
          className={`absolute bottom-20 right-10 w-96 h-96 ${darkMode ? "bg-purple-500/10" : "bg-purple-300/30"
            } rounded-full blur-3xl`}
        />
      </div>
        ...
        <form onSubmit={handleReset} className="px-3 xs:px-4 sm:px-6 md:px-8 pb-4 xs:pb-6 sm:pb-8 space-y-3 xs:space-y-4 sm:space-y-5">
          <div className="relative">
            ...
            <input
              ...
              placeholder="••••••••"
              className={`w-full px-3 py-2.5 xs:py-3 text-sm rounded-lg xs:rounded-xl border ${theme.input} ${focusedField === "pass" ? `${theme.inputFocus} ring-2` : ""
            ...
            <button
              ...
              className="absolute right-2.5 xs:right-3 sm:right-4 bottom-2.5 xs:bottom-3 sm:bottom-3.5 text-gray-400 p-1 cursor-pointer"
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="••••••••"
              className={`w-full px-3 py-2.5 xs:py-3 text-sm rounded-lg xs:rounded-xl border ${theme.input} ${focusedField === "confirm" ? `${theme.inputFocus} ring-2` : ""
                } transition-all duration-200 focus:outline-none pl-9 xs:pl-10 sm:pl-12 pr-9 xs:pr-10 sm:pr-12`}
              required
            />
            <Lock className="absolute left-2.5 xs:left-3 sm:left-4 bottom-2.5 xs:bottom-3 sm:bottom-3.5 text-gray-500 w-4 h-4" />
          ...
          <button
            type="submit"
            className={`w-full ${theme.button} text-white py-2.5 xs:py-3 sm:py-3.5 rounded-lg xs:rounded-xl text-sm font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 flex items-center justify-center gap-2 mt-3 xs:mt-4 cursor-pointer`}
          >
