...
export default function SendText() {
  return (
    <div className="bg-right-nav-light dark:bg-right-nav-dark p-2 border border-gray-300 rounded-full flex justify-center items-center w-full md:mx-4 md:mb-2">
