                ...
                <div className='flex justify-center items-center gap-8 md:gap-12 w-full transition-all duration-300'>
                    ...
                    <button onClick={() => handleSelect('savedlinks')}>
                        {selected === 'savedlinks' ? (
                            <FaBookmark
                                size={36}
                                className='text-violet-600 border-b-2 border-violet-600 pb-2 cursor-pointer'
                            />
                        ) : (
                            <FaRegBookmark
                                size={36}
                                className='text-primary-light/70 dark:text-white/70 pb-2 hover:text-violet-500 transition-colors cursor-pointer'
                            />
                        )}
                    </button>
                </div>
