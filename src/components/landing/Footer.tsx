      ...
      <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col gap-2 sm:gap-3">
              {[
                ...
                <a
                  key={index}
                  href={link.href}
                  className="text-xs sm:text-sm md:text-base transition-colors duration-200 text-gray-400 hover:text-white active:text-gray-300 cursor-pointer"
                >
                  {link.name}
                </a>
              ))}
        ...
        <div className="pt-6 sm:pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-4 sm:gap-6 text-xs sm:text-sm">
            <a
              href="#"
              className="transition-colors duration-200 text-gray-400 hover:text-white active:text-gray-300 cursor-pointer"
            >
              Privacy Policy
            </a>
            <a
