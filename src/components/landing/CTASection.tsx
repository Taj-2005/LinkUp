  ...
  return (
    <section className="py-32 md:py-40 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <div className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] border border-white/10 rounded-3xl md:rounded-[2rem] p-10 md:p-20 text-center shadow-2xl relative overflow-hidden backdrop-blur-sm">
          {}
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              ...
              <motion.button
                ...
                className="px-10 py-5 rounded-2xl font-semibold text-lg bg-white/5 border-2 border-white/10 text-white hover:bg-white/10 backdrop-blur-sm transition-all duration-200 w-full sm:w-auto shadow-lg"
