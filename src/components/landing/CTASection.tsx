        ...
        <div className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] border border-white/10 rounded-2xl sm:rounded-3xl md:rounded-[2rem] p-6 sm:p-8 md:p-10 lg:p-20 text-center shadow-2xl relative overflow-hidden backdrop-blur-sm">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4 mb-8 sm:mb-10 md:mb-12">
              <motion.button
                onClick={onSignUp}
                className="group relative px-6 sm:px-8 md:px-10 py-3.5 sm:py-4 md:py-5 rounded-xl sm:rounded-2xl font-semibold text-sm sm:text-base md:text-lg bg-gradient-to-r from-violet-600 via-purple-600 to-pink-600 text-white shadow-2xl shadow-violet-500/30 w-full sm:w-auto backdrop-blur-sm"
                whileHover={{
                  scale: 1.03,
                  y: -2,
                }}
              ...
              <motion.button
                ...
                className="px-6 sm:px-8 md:px-10 py-3.5 sm:py-4 md:py-5 rounded-xl sm:rounded-2xl font-semibold text-sm sm:text-base md:text-lg bg-white/5 border-2 border-white/10 text-white hover:bg-white/10 backdrop-blur-sm transition-all duration-200 w-full sm:w-auto shadow-lg active:bg-white/15"
